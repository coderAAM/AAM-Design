...
### 👨‍💻 About Me
- 🚀 Full-Stack Web Developer with **production-level project experience**
- 🔐 Strong knowledge of **authentication, encryption & error handling**
- 🧠 Love solving **real-world problems with clean & scalable code**
- 🌱 Currently improving skills in **React & Next.js**
- 💬 Ask me about **Frontend, Backend, APIs & Secure Applications**
...
### ⚡ Fun Fact
⚡ I build production-level applications and still get excited when the code works on the first run 😄
